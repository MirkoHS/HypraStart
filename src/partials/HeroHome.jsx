...
import HeroImage from '../images/heroVideo.jpg'
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Mensaje - Leyenda de que trata la empresa brevemente.
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                <a
                  className="btn text-white bg-greenSecurity-600 hover:bg-greenSecurity-700 w-full mb-4 sm:w-auto sm:mb-0"
                  href="#0"
                >
                  Crea tu cuenta
                </a>
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <a
                  className="btn text-white bg-graySecurity-700 hover:bg-graySecurity-800 w-full sm:w-auto sm:ml-4"
                  href="#0"
                >
                  Quienes somos
                </a>
